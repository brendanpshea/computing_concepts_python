...
qa_data = [
    ...
    ("MC", "clause", "What does a built-in function like <code>print()</code> do?", ["source: notebook", "type: conceptual"],
    ...
    ("MC", "single word or term", "What symbol is used to pass data to a function?", ["source: notebook", "type: technical"],
     "Parentheses <code>()</code>", "Brackets <code>[]</code>", "Braces <code>{}</code>", "Quotes <code>\"\"</code>", 1),
    ("MC", "clause", "In <code>def compute_factorials(n):</code>, what does <code>def</code> do?", ["source: notebook", "type: technical"],
     "It defines a new function", "It deletes the variable <code>n</code>", "It defers execution until later", "It defaults to zero", 1),
    ...
    ("MC", "single word or term", "What is the term for <code>n</code> in <code>compute_factorials(n)</code>?", ["source: notebook", "type: technical"],
     "An input parameter", "A loop test variable", "An accumulator", "An output printer", 1),
    ("MC", "clause", "What is the outcome of passing a string to <code>print()</code>?", ["source: notebook", "type: technical"],
    ...
    ("MC", "clause", "Why is <code>print</code> considered built-in?", ["source: notebook", "type: technical"],
    ...
    ("MR", "complete sentence", "In Python, which concepts apply to functions?", ["source: notebook", "type: technical"],
     "They are reusable blocks of code.", "They can accept input parameters like <code>n</code>.", "They run automatically without being invoked.", "They must always use a while loop inside.", 1),
