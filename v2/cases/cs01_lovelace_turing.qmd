...
When her argument was next picked up — and named — its respondent was Alan Turing. In 1936, a newly elected fellow of King's College, Cambridge and not yet twenty-four, Turing wrote a paper titled "On Computable Numbers, with an Application to the Entscheidungsproblem" [@turing1936]. He asked what it could mean for a number to be *computable* at all. His answer was a thought experiment. Imagine a machine with:
