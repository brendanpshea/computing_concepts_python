...
1. Run the `setup_pass` snippet. It skips the position check once every 256 keypresses. Change the code so the check is *never* skipped. What does your version print for 260 keypresses?
